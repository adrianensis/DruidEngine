...
#define test(theClass) std::chrono::duration<double> __test__totaltime; auto t = std::chrono::high_resolution_clock::now(); std::ostringstream __test__output; __test__output << std::endl << std::endl << std::endl <<   "===========  " << #theClass << "  ===========" << std::endl << std::endl; theClass __test__any; bool __test__bool; f32 __test__float; f64 __test__float_precision; i64 __test__sint; u64 __test__uint; int __test__ok = 0; int __test__total = 0; bool __test__b
...
#define summary() __test__output << std::endl << std::setprecision(4) << std::chrono::duration_cast<std::chrono::microseconds>(__test__totaltime).count() / 1000.0f << " " << __test__ok << " " <<(__test__total-__test__ok) << std::endl; std::cout << __test__output.str();
