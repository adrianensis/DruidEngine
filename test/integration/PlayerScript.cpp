...
void PlayerScript::createWall(f32 x, f32 y){
  ...
  renderer->addAnimation("tornado", Animation::create(3, true, false, Vector2(0,0.0f/1.0f), 1.0f/3.0f, 1.0f/1.0f, 15));
...
void PlayerScript::createProjectile(f32 x, f32 y, f32 clickX, f32 clickY){
  ...
  if(mElement == Element::FIRE){
    renderer->addAnimation("fire", Animation::create(3, true, false, Vector2(0,1.0f/3.0f), 1.0f/3.0f, 1.0f/3.0f, 10));
  }else if(mElement == Element::ICE){
    renderer->addAnimation("fire", Animation::create(3, true, false, Vector2(0,2.0f/3.0f), 1.0f/3.0f, 1.0f/3.0f, 10));
  } else {
    renderer->addAnimation("fire", Animation::create(3, true, false, Vector2(0,2.0f/3.0f), 1.0f/3.0f, 1.0f/3.0f, 10));
  }

  renderer->addAnimation("explosion", Animation::create(3, true, false, Vector2(0,0.0f/3.0f), 1.0f/3.0f, 1.0f/3.0f, 8));
