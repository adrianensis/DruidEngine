...
int main() {
	...
	DE_test_expected(DE::Vector2(a) += a, DE::Vector2(0 + 0, 1 + 1));
	DE_test_expected(DE::Vector2(a) *= a, DE::Vector2(0 * 0, 1 * 1));
	DE_test_expected(DE::Vector2(a) /= DE::Vector2(2, 2),
			DE::Vector2(0 / 2.0f, 1 / 2.0f));
	...
	DE_test_expected(DE::Vector2(a).mul(DE::Vector2(2, 2)),
			DE::Vector2(0 * 2, 1 * 2));
	DE_test_expected(DE::Vector2(a).div(DE::Vector2(2, 2)),
			DE::Vector2(0 / 2.0f, 1 / 2.0f));
	...
	DE_test_expected(DE::Vector2(b).lerp(a, 0.5f),
			DE::Vector2(b) += (a - b) * 0.5f);
	DE_test_expected(DE::Vector2(b).lerp(a, 0.1f),
			DE::Vector2(b) += (a - b) * 0.1f);
	DE_test_expected(DE::Vector2(b).lerp(a, 0.823f),
			DE::Vector2(b) += (a - b) * 0.823f);
	...
	DE_test_expected_float(
			DE::Vector2(1, 0).angle(DE::Vector2(0, 1)) * (180 / MathUtils::PI),
			90);
	DE_test_expected_float(
			DE::Vector2(1, 0).angle(DE::Vector2(1, 1)) * (180 / MathUtils::PI),
			45);
	DE_test_expected_float(
			DE::Vector2(1, 0).angle(DE::Vector2(1, -1)) * (180 / MathUtils::PI),
			315);
	DE_test_expected_float(
			DE::Vector2(1, 0).angle(DE::Vector2(-1, 0)) * (180 / MathUtils::PI),
			180);
