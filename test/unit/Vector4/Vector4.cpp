...
int main() {
	...
	DE_test_expected(b / DE::Vector4(1, 1, 2, 3),
			DE::Vector4(4 / 1.0f, 5 / 1.0f, 6 / 2.0f, 7 / 3.0f));
	DE_test_expected(DE::Vector4(a) -= a,
			DE::Vector4(0 - 0, 1 - 1, 2 - 2, 3 - 3));
	DE_test_expected(DE::Vector4(a) += a,
			DE::Vector4(0 + 0, 1 + 1, 2 + 2, 3 + 3));
	DE_test_expected(DE::Vector4(a) *= a,
			DE::Vector4(0 * 0, 1 * 1, 2 * 2, 3 * 3));
	DE_test_expected(DE::Vector4(a) /= DE::Vector4(1, 1, 2, 3),
			DE::Vector4(0 / 1.0f, 1 / 1.0f, 2 / 2.0f, 3 / 3.0f));
	...
	DE_test_expected(DE::Vector4(a).add(a),
			DE::Vector4(0 + 0, 1 + 1, 2 + 2, 3 + 3));
	DE_test_expected(DE::Vector4(a).sub(a),
			DE::Vector4(0 - 0, 1 - 1, 2 - 2, 3 - 3));
	DE_test_expected(DE::Vector4(a).mul(DE::Vector4(2, 2, 2, 2)),
			DE::Vector4(0 * 2, 1 * 2, 2 * 2, 3 * 2));
	DE_test_expected(DE::Vector4(a).div(DE::Vector4(2, 2, 2, 2)),
			DE::Vector4(0 / 2.0f, 1 / 2.0f, 2 / 2.0f, 3 / 2.0f));
	DE_test_expected(DE::Vector4(a).add(1),
			DE::Vector4(0 + 1, 1 + 1, 2 + 1, 3 + 1));
	DE_test_expected(DE::Vector4(a).sub(1),
			DE::Vector4(0 - 1, 1 - 1, 2 - 1, 3 - 1));
	DE_test_expected(DE::Vector4(a).mul(2),
			DE::Vector4(0 * 2, 1 * 2, 2 * 2, 3 * 2));
	DE_test_expected(DE::Vector4(a).div(2),
			DE::Vector4(0 / 2.0f, 1 / 2.0f, 2 / 2.0f, 3 / 2.0f));

	DE_test_show(c.div(2));
	DE_test_expected(c, DE::Vector4(1 / 2.0f, 2 / 2.0f, 2 / 2.0f, 3 / 2.0f));

	DE_test_expected(DE::Vector4(b).lerp(a, 0.5f),
			DE::Vector4(b) += (a - b) * 0.5f);
	DE_test_expected(DE::Vector4(b).lerp(a, 0.1f),
			DE::Vector4(b) += (a - b) * 0.1f);
	DE_test_expected(DE::Vector4(b).lerp(a, 0.823f),
			DE::Vector4(b) += (a - b) * 0.823f);
