...
int main() {
	...
	DE_test_expected(b / DE::Vector3(1, 1, 2), DE::Vector3(4 / 1.0f, 5 / 1.0f, 6 / 2.0f));
	DE_test_expected(DE::Vector3(a) -= a, DE::Vector3(0 - 0, 1 - 1, 2 - 2));
	DE_test_expected(DE::Vector3(a) += a, DE::Vector3(0 + 0, 1 + 1, 2 + 2));
	DE_test_expected(DE::Vector3(a) *= a, DE::Vector3(0 * 0, 1 * 1, 2 * 2));
	DE_test_expected(DE::Vector3(a) /= DE::Vector3(1, 1, 2), DE::Vector3(0 / 1.0f, 1 / 1.0f, 2 / 2.0f));
	...
	DE_test_expected(DE::Vector3(a).mul(DE::Vector3(2, 2, 2)), DE::Vector3(0 * 2, 1 * 2, 2 * 2));
	DE_test_expected(DE::Vector3(a).div(DE::Vector3(2, 2, 2)), DE::Vector3(0 / 2.0f, 1 / 2.0f, 2 / 2.0f));
	...
	DE_test_expected(DE::Vector3(a).div(2), DE::Vector3(0 / 2.0f, 1 / 2.0f, 2 / 2.0f));

	DE_test_show(c.div(2));
	DE_test_expected(c, DE::Vector3(1 / 2.0f, 2 / 2.0f, 2 / 2.0f));

	DE_test_expected(DE::Vector3(b).lerp(a, 0.5f), DE::Vector3(b) += (a - b) * 0.5f);
	DE_test_expected(DE::Vector3(b).lerp(a, 0.1f), DE::Vector3(b) += (a - b) * 0.1f);
	DE_test_expected(DE::Vector3(b).lerp(a, 0.823f), DE::Vector3(b) += (a - b) * 0.823f);
	...
	DE_test_expected_float_eps(DE::Vector3(1, 0, 0).angle(DE::Vector3(1, -1, 0)) * (180 / MathUtils::PI), 45, 0.00001f);
	DE_test_expected_float_eps(DE::Vector3(-1, 0, 0).angle(DE::Vector3(-1, -1, 0)) * (180 / MathUtils::PI), 45,
			0.00001f);
