...
int main() {
	...
	expected_float(a.dot(a), a.x*a.x + a.y*a.y + a.z*a.z);
	expected_float(a.dot(b), a.x*b.x + a.y*b.y + a.z*b.z);
	expected_float(a.sqrlen(), a.dot(a));
	expected_float(a.len(), sqrtf(a.sqrlen()));
	expected_float(a.max(),2);
	expected_float(a.min(),0);
	expected_float(a.sqrdst(b),(a-b).dot(a-b));
	expected_float(a.dst(b), sqrtf(a.sqrdst(b)));
	...
	expected_float(a.angle(a, DE::Vector3(0,1,0)), 0.0);
	expected_float(DE::Vector3(1,0,0).angle(DE::Vector3(0,1,0), DE::Vector3(0,0,1))*(180/M_PI), 90);
	expected_float(DE::Vector3(1,0,0).angle(DE::Vector3(0,-1,0), DE::Vector3(0,0,1))*(180/M_PI), 270);
	expected_float(DE::Vector3(1,0,0).angle(DE::Vector3(1,1,0), DE::Vector3(0,0,1))*(180/M_PI), 45);
	expected_float(DE::Vector3(1,0,0).angle(DE::Vector3(1,-1,0), DE::Vector3(0,0,1))*(180/M_PI), 315);
	expected_float(DE::Vector3(-1,0,0).angle(DE::Vector3(-1,-1,0), DE::Vector3(0,0,1))*(180/M_PI), 45);
	expected_float(DE::Vector3(1,0,0).angle(DE::Vector3(-1,0,0), DE::Vector3(0,1,0))*(180/M_PI), 180);
	expected_float(DE::Vector3(1,0,0).angle(DE::Vector3(-1,0,1), DE::Vector3(0,1,0))*(180/M_PI), 225);
	expected_float(DE::Vector3(1,0,0).angle(DE::Vector3(-1,0,-1), DE::Vector3(0,1,0))*(180/M_PI), 135);

	expected_float_eps(DE::Vector3(a).clamp(0.1f).len(),0.1f,0.00001f);
	expected_float_eps(DE::Vector3(a).clamp(0.2f).len(),0.2f,0.00001f);
	expected_float_eps(DE::Vector3(a).clamp(0.3f).len(),0.3f,0.00001f);
	expected_float_eps(DE::Vector3(a).clamp(0.4f).len(),0.4f,0.00001f);
	expected_float_eps(DE::Vector3(a).clamp(0.5f).len(),0.5f,0.00001f);
