...
int main() {
	...
	DE::Array<u32>* array = DE::DE_NEW<Array<u32>>();
	...
	DE::Array<u32>* copy = DE::DE_NEW<Array<u32>>();
	copy->init(*array);
	...
	DE::Array<u32>* copy2 = DE::DE_NEW<Array<u32>>();
	copy2->init(*array);
	...
	DE::Array<u32>* array2 = DE::DE_NEW<Array<u32>>();
	array2->init(10);
