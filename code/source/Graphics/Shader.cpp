...
void Shader::initInternal(const std::string &vertex,
	...
	std::string vertexShaderSource((std::istreambuf_iterator<char>(vertex_ifs)),
	...
	if (!success) {
		...
		std::cout << "ERROR::SHADER::VERTEX::COMPILATION_FAILED\n" << infoLog
				<< std::endl << vertexShaderSource << std::endl;
	}
...
void Shader::init() {
	...
	initInternal("resources/shaders/vertex.shader",
...
void Shader::initDebug() {
	...
	initInternal("resources/shaders/vertexDebug.shader",
			"resources/shaders/fragmentDebug.shader");
}
