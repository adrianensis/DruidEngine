...
#define DE_test(theClass)\
    float __test__totaltime = 0;\
    std::chrono::duration<double, std::milli> elapsed;\
    auto t = std::chrono::high_resolution_clock::now();\
    std::ostringstream __test__output;\
    __test__output << std::endl << std::endl << std::endl <<   "===========  " << #theClass << "  ===========" << std::endl << std::endl;\
...
#define DE_test_title(text)\
__test__output << std::endl << std::endl << std::endl <<   "===========  " << text << "  ===========" << std::endl << std::endl;
...
#define DE_test_expected_any(aux,x,exp)\
DE_test_tick();\
aux = (x);\
DE_test_tock();\
__test__total++;\
__test__b = (aux==(exp));\
if (__test__b){ __test__ok++; }\
__test__output  <<\
(__test__b ? "[ OK ]" : "[ FAIL ]") << "\t" << #x << std::endl <<\
"\t" << "result: " << __PRECISION << aux << std::endl <<\
"\t" << "DE_test_expected: " << __PRECISION << (exp) << std::endl << std::endl;
...
#define DE_test_expected_float_eps(x,exp,eps)\
DE_test_tick();\
...
"\t" << "DE_test_expected: " << __PRECISION << (exp) << std::endl <<\
"\t" << "epsilon: " << __PRECISION << (eps) << std::endl << std::endl;
