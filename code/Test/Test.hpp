...
#define test_tock() elapsed = std::chrono::high_resolution_clock::now()-t; __test__totaltime += elapsed.count();

#define test_blank() __test__output << std::endl;
#define test_show(x) __test__output << #x << " = " << (x) << std::endl << std::endl;
...
"\t" << "test_expected: " << __PRECISION << (exp) << std::endl << std::endl;
